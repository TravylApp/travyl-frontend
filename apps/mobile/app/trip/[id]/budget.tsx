...
import { useItineraryScreen, MOCK_BUDGET_ITEMS, TAB_COLORS } from '@travyl/shared';
    ...
    <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
      <View style={{ flexDirection: 'row', gap: 8, marginBottom: 16 }}>
        {['Total Budget', 'Total Spent', 'Remaining'].map((label) => (
          <View key={label} style={{ flex: 1, backgroundColor: '#fff', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#e5e7eb' }}>
            <Text style={{ fontSize: 10, color: '#6b7280', textTransform: 'uppercase' }}>{label}</Text>
            <SkeletonBlock width="80%" height={22} style={{ marginTop: 4 }} />
          </View>
        ))}
      </View>
      <View style={{ backgroundColor: '#f3f4f6', borderRadius: 6, height: 10, marginBottom: 20, overflow: 'hidden' }}>
        <View style={{ width: '65%', height: '100%', backgroundColor: '#10b981', borderRadius: 6 }} />
      </View>
      <View style={{ gap: 10 }}>
        {[1, 2, 3, 4].map((i) => (
          <View key={i} style={{ backgroundColor: '#fff', borderRadius: 10, padding: 14, borderWidth: 1, borderColor: '#e5e7eb' }}>
...
export default function BudgetScreen() {
  ...
  if (budgetData.length === 0) {
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 48, paddingHorizontal: 24, backgroundColor: '#fff' }}>
        <View style={{ width: 56, height: 56, borderRadius: 28, backgroundColor: TAB_COLORS.budget + '15', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
          <FontAwesome name="pie-chart" size={24} color={TAB_COLORS.budget} />
        </View>
        <Text style={{ fontSize: 17, fontWeight: '700', color: '#111827', marginBottom: 6 }}>No expenses yet</Text>
        ...
        <Pressable
          ...
          style={{ backgroundColor: TAB_COLORS.budget, paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }}
        >
    ...
    <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
      ...
      <View style={{ flexDirection: 'row', gap: 8, marginBottom: 16 }}>
        ...
        <View style={{ flex: 1, backgroundColor: overallHealth.bg, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: overallHealth.border }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 2 }}>
            <Text style={{ fontSize: 10, color: '#6b7280', textTransform: 'uppercase' }}>Total Budget</Text>
            {!isEditingTotal ? (
              <Pressable
        ...
        {/* Total Spent */}
        <View style={{ flex: 1, backgroundColor: overallHealth.bg, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: overallHealth.border }}>
          <Text style={{ fontSize: 10, color: '#6b7280', textTransform: 'uppercase', marginBottom: 2 }}>Total Spent</Text>
          <Text style={{ fontSize: 18, fontWeight: '700', color: '#111827', marginTop: 2 }}>
        ...
        <View style={{ flex: 1, backgroundColor: overallHealth.bg, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: remaining >= 0 ? '#10b98130' : '#ef444430' }}>
          <Text style={{ fontSize: 10, color: '#6b7280', textTransform: 'uppercase', marginBottom: 2 }}>Remaining</Text>
      ...
      <View style={{ backgroundColor: overallHealth.bg, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: overallHealth.border, marginBottom: 16 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
          <Text style={{ fontSize: 13, fontWeight: '500', color: '#374151' }}>Budget Progress</Text>
          <Text style={{ fontSize: 13, fontWeight: '600', color: '#111827' }}>{pctUsed.toFixed(1)}%</Text>
        </View>
        <View style={{ backgroundColor: '#e5e7eb', borderRadius: 6, height: 10, overflow: 'hidden' }}>
          <View
            style={{
      ...
      <View style={{ backgroundColor: '#fff', borderRadius: 10, padding: 14, borderWidth: 1, borderColor: '#e5e7eb', marginBottom: 16 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
          <Text style={{ fontSize: 14, fontWeight: '600', color: '#111827' }}>Daily Spending</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            <Text style={{ fontSize: 11, color: '#6b7280' }}>Avg:</Text>
            <Text style={{ fontSize: 11, fontWeight: '600', color: '#111827' }}>${avgDailySpend}</Text>
          </View>
        </View>
          ...
          {DAILY_SPENDING.map((d, idx) => {
            ...
            return (
              <View key={idx} style={{ alignItems: 'center', flex: 1, gap: 4 }}>
                {/* Amount label */}
                <Text style={{ fontSize: 9, fontWeight: '500', color: isHighest ? '#ef4444' : '#6b7280' }}>
                  ${d.amount}
                </Text>
                {/* Bar */}
                <View
                  style={{
                    ...
                    backgroundColor: isHighest ? '#ef4444' : TAB_COLORS.budget,
                    borderRadius: 4,
                    opacity: isHighest ? 1 : 0.7,
                  }}
                />
                {/* Day label */}
                <Text style={{ fontSize: 10, color: '#6b7280', position: 'absolute', bottom: -18 }}>
                  {d.day}
                </Text>
              </View>
            );
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#f3f4f6' }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
        <Text style={{ fontSize: 14, fontWeight: '600', color: '#111827' }}>Category Breakdown</Text>
        <Text style={{ fontSize: 11, color: '#6b7280' }}>{budgetData.length} categories</Text>
      </View>
      ...
      <View style={{ gap: 10 }}>
            ...
            >
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                  ...
                  <View>
                    <Text style={{ fontSize: 14, fontWeight: '600', color: '#111827' }}>{item.category}</Text>
                    {!isExpanded && (
                      <Text style={{ fontSize: 12, color: '#6b7280' }}>${item.actual.toLocaleString()}</Text>
                    )}
                  </View>
                </View>
                  ...
                  {!isEditing ? (
                    <>
                      ...
                      <View style={{ flexDirection: 'row', gap: 12, marginBottom: 10 }}>
                        <View style={{ flex: 1 }}>
                          <Text style={{ fontSize: 11, color: '#6b7280', marginBottom: 4 }}>Budgeted</Text>
                        ...
                        <View style={{ flex: 1 }}>
                          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                            <Text style={{ fontSize: 11, color: '#6b7280' }}>Actual</Text>
                      ...
                      <View style={{ backgroundColor: '#ffffff', borderRadius: 4, height: 6, overflow: 'hidden', marginBottom: 8 }}>
                        <View
                          style={{
                      ...
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 }}>
                        <Text style={{ fontSize: 11, color: '#6b7280' }}>{itemPct.toFixed(0)}% used</Text>
                        {itemDiff > 0 ? (
                          ...
                          <Text style={{ fontSize: 11, color: '#6b7280' }}>On track</Text>
                        )}
                      </View>
                      ...
                      <View style={{ borderTopWidth: 1, borderTopColor: '#e5e7eb', paddingTop: 12 }}>
                        ...
                        {item.expenses && item.expenses.length > 0 && (
                          <View style={{ marginBottom: 12 }}>
                            ...
                            >
                              <Text style={{ fontSize: 11, fontWeight: '600', color: '#374151', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                            ...
                            {expandedExpenses.has(item.id) && (
                              <View style={{ gap: 6, marginBottom: 8 }}>
                                {item.expenses.map((expense) => (
                                  ...
                                  >
                                    <Text style={{ fontSize: 12, color: '#374151', flex: 1, marginRight: 8 }} numberOfLines={1}>
                                      {expense.description}
                                    </Text>
                        ...
                        {addingExpenseFor === item.id ? (
                          <View style={{ backgroundColor: '#ffffff', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#e5e7eb' }}>
                            <Text style={{ fontSize: 11, fontWeight: '500', color: '#374151', marginBottom: 6 }}>Description</Text>
                            <TextInput
                            ...
                            />
                            <Text style={{ fontSize: 11, fontWeight: '500', color: '#374151', marginBottom: 6 }}>Amount</Text>
                            <TextInput
                          ...
                          >
                            ...
                            <Text style={{ fontSize: 13, fontWeight: '500', color: '#374151' }}>Add Expense</Text>
                          </Pressable>
                        )}
                      </View>
                    </>
                    ...
                    <View>
                      <Text style={{ fontSize: 11, color: '#6b7280', marginBottom: 6 }}>Budgeted</Text>
                      <TextInput
                        value={tempBudgeted}
        ...
        {!showAddCategory ? (
          ...
          >
            ...
            <Text style={{ fontSize: 13, fontWeight: '500', color: '#6b7280' }}>Add Category</Text>
          </Pressable>
        ) : (
          <View style={{ backgroundColor: '#ecfdf5', borderRadius: 10, borderWidth: 2, borderColor: '#6ee7b7', padding: 16 }}>
            <Text style={{ fontSize: 11, fontWeight: '500', color: '#374151', marginBottom: 6 }}>Category Name</Text>
            <TextInput
              value={newCategory}
            ...
            />
            <Text style={{ fontSize: 11, fontWeight: '500', color: '#374151', marginBottom: 6 }}>Budgeted Amount</Text>
            <TextInput
              value={newBudgeted}
            ...
            />
            <Text style={{ fontSize: 11, fontWeight: '500', color: '#374151', marginBottom: 6 }}>Actual Spent</Text>
            <TextInput
              value={newActual}
