    ...
    <div className="space-y-4">
      ...
      {(showForm || !hasSearched) && (
        <div className="rounded-xl border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.03] p-4">
          <div className="flex items-center justify-between mb-3">
            <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Search flights</p>
            {hasSearched && (
              <button
      ...
      {!loading && hasSearched && !error && results.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">No flights found for this route and date.</p>
            ...
            <div className="flex-1 min-w-0">
              {filtered.length === 0 ? (
                <div className="text-center py-16 rounded-xl border border-dashed border-gray-200 dark:border-white/[0.08]">
                  <p className="text-sm text-gray-500 dark:text-gray-400">No flights match these filters.</p>
                  <button
                    onClick={clearFilters}
