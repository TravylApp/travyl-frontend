    ...
    <div>
      {day.theme && (
        <div className="flex items-center gap-2 mb-3.5 px-1">
          <Flag size={13} className="text-gray-500 dark:text-gray-400" />
          <h2 className="text-[15px] font-semibold text-gray-800 dark:text-gray-100">{day.theme}</h2>
        </div>
      )}
      ...
      {day.notes && (
        <div className="bg-gray-50 dark:bg-white/[0.04] rounded-[10px] p-3 mt-1 mb-3 border border-gray-100 dark:border-white/[0.06]">
          <p className="text-xs text-gray-500 dark:text-gray-400 italic leading-[18px]">{day.notes}</p>
        </div>
      )}
    </div>
  );
