...
export function SpotlightFooter({ resultCount, isActionMode, isCreatorMode, creatorPhase }: Props) {
  if (isCreatorMode) {
    // During clarifying phase, show A/B/C/D keyboard hints
    ...
    // Default creator mode footer (extracting, planning, etc.)
    return (
      <div className="flex items-center justify-between px-4 py-2 border-t border-gray-200 dark:border-gray-700 text-xs text-gray-400 dark:text-gray-500">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1">
