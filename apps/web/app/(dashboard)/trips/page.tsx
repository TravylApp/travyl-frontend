      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 flex-1 w-full">
        ...
        {displayTrips.length > 0 ? (
                ...
                {pastTrips.length > 0 && (
                  <div className="mt-10">
                    <div className="flex items-center gap-3 mb-4">
                      <h2 className="text-lg font-serif font-normal text-gray-400 dark:text-gray-500 tracking-wide">Past Trips</h2>
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h2 className="text-lg font-serif font-normal text-gray-800 dark:text-gray-200 mb-1 tracking-wide">No trips yet</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-xs">Start planning your next adventure and it will appear here.</p>
