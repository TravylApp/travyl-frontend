    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden bg-black">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h1 className="text-white font-serif italic text-[80px] xl:text-[100px] 2xl:text-[120px] leading-[0.85] tracking-tighter mb-3 font-light">
              {dest.name}
            </h1>
            <p className="text-white/60 text-lg xl:text-xl tracking-[4px] uppercase mb-5">
              {dest.country}
            </p>
            <p className="text-white font-serif text-lg mb-8 font-light">
              {dest.tagline}
            </p>
