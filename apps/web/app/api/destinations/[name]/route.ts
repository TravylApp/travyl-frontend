...
const DESTINATIONS: Record<string, DestinationDetail> = {
  'paris': {
    ...
    language: 'French', currency: 'Euro (EUR)', timezone: 'CET / UTC+1',
  ...
  'london': {
    ...
    language: 'English', currency: 'British Pound (GBP)', timezone: 'GMT / UTC+0',
  ...
  'tokyo': {
    ...
    language: 'Japanese', currency: 'Japanese Yen (JPY)', timezone: 'JST / UTC+9',
  ...
  'new york': {
    ...
    language: 'English', currency: 'US Dollar (USD)', timezone: 'EST / UTC\u22125',
  ...
  'rome': {
    ...
    language: 'Italian', currency: 'Euro (EUR)', timezone: 'CET / UTC+1',
    bestTimeToVisit: 'April \u2013 June, September \u2013 October', budgetLevel: 3,
  ...
  'barcelona': {
    ...
    language: 'Catalan / Spanish', currency: 'Euro (EUR)', timezone: 'CET / UTC+1',
  ...
  'dubai': {
    ...
    language: 'Arabic', currency: 'UAE Dirham (AED)', timezone: 'GST / UTC+4',
  ...
  'sydney': {
    ...
    language: 'English', currency: 'Australian Dollar (AUD)', timezone: 'AEDT / UTC+11',
  ...
  'bangkok': {
    ...
    language: 'Thai', currency: 'Thai Baht (THB)', timezone: 'ICT / UTC+7',
  ...
  'amsterdam': {
    ...
    language: 'Dutch', currency: 'Euro (EUR)', timezone: 'CET / UTC+1',
  ...
  'istanbul': {
    ...
    language: 'Turkish', currency: 'Turkish Lira (TRY)', timezone: 'TRT / UTC+3',
  ...
  'singapore': {
    ...
    language: 'English / Mandarin / Malay / Tamil', currency: 'Singapore Dollar (SGD)', timezone: 'SGT / UTC+8',
  ...
  'lisbon': {
    ...
    language: 'Portuguese', currency: 'Euro (EUR)', timezone: 'WET / UTC+0',
  ...
  'prague': {
    ...
    language: 'Czech', currency: 'Czech Koruna (CZK)', timezone: 'CET / UTC+1',
  ...
  'berlin': {
    ...
    language: 'German', currency: 'Euro (EUR)', timezone: 'CET / UTC+1',
  ...
  'bali': {
    ...
    language: 'Balinese / Indonesian', currency: 'Indonesian Rupiah (IDR)', timezone: 'WITA / UTC+8',
...
export async function GET(
  ...
  if (known) return jsonResponse(known, 3600)
  ...
  try {
    ...
    if (!geoRes.ok) return jsonResponse(null, 3600)

    const results: NominatimResult[] = await geoRes.json()
    if (!results.length) return jsonResponse(null, 3600)
    ...
    const fallback: DestinationDetail = {
      ...
      language: '', currency: '', timezone: '', bestTimeToVisit: '',
      budgetLevel: 2, tags: [],
